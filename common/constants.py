...
COPYCAT_VARIANCE_THRESHOLD = 0.005
EXACT_MATCH_PREDICTIONS_THRESHOLD = 5
SUSPICIOUS_CONSECUTIVE_MATCHES_THRESHOLD = 5
SUSPICIOUS_MATCH_PREDICTIONS_THRESHOLD = 10
